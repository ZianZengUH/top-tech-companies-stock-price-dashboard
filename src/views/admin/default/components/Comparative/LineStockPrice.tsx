...
export default function LineStockPrice({tick, name, cutoff}: currentTick) {
	// Chakra Color Mode
	...
	useEffect(() => {
		async function fetchData() {
			let response = await fetch('/data/top_tech_company/Financial/AdjReturns/adjClose' + tick + value + '.csv')
			...
			<Flex me="50px" mt="20px">
              ...
              {tickerOptions}
				...
				<Box minH='260px' minW='75%' mt='auto'>
					<LineChart chartData={newData} chartOptions={lineChartOptionsAdjRev} />
				</Box>
		</Card>
	);
}
